...
import avata from "@/images/pharmacist.png";
        ...
        >
          ...
          <div className="flex flex-col ml-2">
            <span className="ml-2 text-sm">
              Hi, DS. <strong>{pharmacist?.user_name}</strong>
            </span>
            ...
            <div className="py-2">
              ...
              <div className="flex px-4 py-2 items-center">
                ...
                <div className="flex flex-col ml-4">
                  <span className="font-medium">{pharmacist?.user_name}</span>
                  <span className="text-gray-500 text-sm">Dược sĩ</span>
