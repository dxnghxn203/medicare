...
import AdminDetailModal from "./userDetailModal";
...
const AdminTable = ({
  ...
  const toggleAdminMenu = (userId: string) => {
    setOpenMenuAdminId((prev) => (prev === userId ? null : userId));
  };
  ...
  const openAdminDetail = (user: any) => {
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            {admins.map((user) => (
              <tr key={user._id} className="hover:bg-gray-50 relative">
                ...
                <td className="px-2 py-4 justify-center whitespace-nowrap">
                  <span
                    className={`px-2 py-1 w-fit text-xs font-semibold rounded-full flex items-center justify-center ${
